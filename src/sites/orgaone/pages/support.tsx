// /Users/luca/Projects/lacodea/src/sites/orgaone/pages/support.tsx
...
export default async function OrgaOneSupport() {
      ...
      <div className="grid gap-6 lg:grid-cols-3 lg:items-start">
        ...
        <section className="card p-6 md:p-7 lg:col-span-2">
          <h2 className="text-lg md:text-xl font-semibold tracking-tight">
            {t(locale, "orgaone.support.faqTitle")}
          </h2>
          ...
          <div className="mt-4 space-y-3">
            ...
            {faqs.length === 0 && (
              <p className="muted text-sm">{t(locale, "orgaone.support.noFaq")}</p>
            )}
          </div>
        </section>
        ...
        <aside className="card p-6 md:p-7">
          <h2 className="text-lg md:text-xl font-semibold tracking-tight">
            {t(locale, "orgaone.support.contactTitle")}
          </h2>

          <p className="muted mt-2 text-sm leading-relaxed">
            {t(locale, "orgaone.support.contactBody")}
          </p>

          <div className="mt-4">
            <Link className="btn btn-primary w-fit" href={`${base}/contact`}>
              {t(locale, "orgaone.support.contactCta")}
            </Link>
          </div>
          ...
          <div className="muted text-xs">
            {t(locale, "orgaone.support.contactHint")}
          </div>
        </aside>
      </div>
    </main>
