...
const APPS_QUERY = `*[_type == "app"] | order(sortOrder asc, name asc) {
  _id,
  name,
  "slug": slug.current,
  sortOrder,
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {apps.map((app) => {
          ...
          return (
            <div
              key={app._id}
              className="rounded-2xl border border-black/10 bg-white/60 p-4 shadow-sm backdrop-blur dark:border-white/10 dark:bg-white/5"
            >
